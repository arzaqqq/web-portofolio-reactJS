               ...
               <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className='flex items-center gap-2 mt-auto'>
                    {socialLinks.map(({href, icon}, key) =>(
                        ...
                        href={href} 
                        target='_blank'
                        className="w-12 h-12 grid place-items-center ring-2 ring-zinc-50/5 rounded-lg transition-[backgorund-color, color] hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-50/80">
                            {icon}
                        </a>
                    ))}
                </div>
